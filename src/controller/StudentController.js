...
export default class StudentController {
  ...
  @GetMapping('/')
  async list(params) {
    this.log.info(`StudentController::list 호출됨 -> params=${JSON.stringify(params)}`);
  ...
  async listPaged(params) {
    this.log.info(`StudentController::listPaged 호출됨 -> page=${params.page} perPage=${params.perPage}`);
  ...
  @GetMapping('/:id')
  async get(params) {
    this.log.info(`StudentController::get 호출됨 -> params=${JSON.stringify(params)}`);
  ...
  async create(params, req, res) {
    this.log.info(`StudentController::create 호출됨 -> params=${JSON.stringify(params)}`);
  ...
  async update(params) {
    this.log.info(`StudentController::update 호출됨 -> params=${JSON.stringify(params)}`);
