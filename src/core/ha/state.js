 ...
 */
export function nextState() { return null; }
export function validateTimings() { return null; }
export const ROLE = () => (t) => t;
export const DEFAULT_TIMINGS = () => (t) => t;

export default { nextState, validateTimings, ROLE, DEFAULT_TIMINGS };
