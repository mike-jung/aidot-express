 ...
 */
export function envelopeEncrypt() { return null; }
export function envelopeDecrypt() { return null; }
export function deterministicIndex() { return null; }
export const constants = null;

export default { envelopeEncrypt, envelopeDecrypt, deterministicIndex, constants };
