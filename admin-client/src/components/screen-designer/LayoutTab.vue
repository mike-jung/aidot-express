  ...
  <div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <p class="text-secondary small mb-0">
        {{ t('designer.layoutHint') }}
        <span class="text-muted">{{ t('designer.autoSaved') }}</span>
      </p>
      <div class="save-indicator">
        <span v-if="saveState === 'pending'" class="text-secondary small">
          <i class="bi bi-pencil-square me-1"></i>{{ t('designer.editing') }}
        </span>
    ...
    <div class="row g-3">
      ...
      <div class="col-lg-6">
        <h6 class="mb-2">
          <i class="bi bi-grid-1x2 me-1"></i>{{ t('designer.pickStructure') }}
        </h6>
      ...
      <div class="col-lg-6">
        <div class="right-sticky">
          <h6 class="mb-2">
            <i class="bi bi-eye me-1"></i>{{ t('designer.preview') }}
          </h6>
          <LayoutPreview :layout="localLayout" />

          <h6 class="mb-2 mt-4">
            <i class="bi bi-sliders me-1"></i>{{ t('designer.details') }}
          </h6>
