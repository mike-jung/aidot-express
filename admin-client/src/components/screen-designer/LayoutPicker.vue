...
const presets = [
  { kind: 'sidebar-left',  label: '좌측 사이드바',        description: '일반적인 어드민 레이아웃. 좌측 메뉴 + 상단 타이틀.', category: 'admin' },
  { kind: 'sidebar-dark',  label: '어두운 사이드바',      description: '좌측 메뉴가 어두운 톤. 대시보드 느낌.',         category: 'admin' },
  { kind: 'top-nav',       label: '상단 네비',            description: '사이드바 없이 상단 네비만. 단순한 페이지용.',     category: 'web' },
  { kind: 'sidebar-right', label: '우측 사이드바',        description: '우측에 사이드 메뉴 — 콘텐츠 중심 배치.',         category: 'admin' },
  { kind: 'sidebar-both',  label: '좌우 사이드바',        description: '메인 메뉴 + 보조 패널을 양쪽에 배치.',           category: 'admin' },
  { kind: 'top-and-side',  label: '상단 + 좌측',          description: '상단 네비와 좌측 서브 메뉴 — 2단계 네비게이션.', category: 'admin' },
  { kind: 'hero-landing',  label: 'Hero 랜딩',            description: '히어로 섹션 + 스크롤 콘텐츠 — 랜딩 페이지용.',   category: 'web' },
  { kind: 'split-panel',   label: '좌우 분할',            description: '좌우 동일 분할 — 마스터-디테일 패턴.',           category: 'app' },
  { kind: 'card-grid',     label: '카드 그리드',          description: '전체 화면 카드 그리드 — 대시보드형.',            category: 'app' },
];
