...
export function genWidgetSfcs() {
  return [
    { path: 'src/components/widgets/StatWidget.vue',     content: STAT_WIDGET,     source: 'widget' },
    { path: 'src/components/widgets/ListWidget.vue',     content: LIST_WIDGET,     source: 'widget' },
    { path: 'src/components/widgets/ListPagedWidget.vue', content: LIST_PAGED_WIDGET, source: 'widget' },
    { path: 'src/components/widgets/DetailWidget.vue',   content: DETAIL_WIDGET,   source: 'widget' },
    { path: 'src/components/widgets/TextWidget.vue',     content: TEXT_WIDGET,     source: 'widget' },
    ...
    { path: 'src/components/widgets/QueryFormWidget.vue',  content: QUERY_FORM_WIDGET,  source: 'widget' },
    { path: 'src/components/widgets/FormDialogWidget.vue', content: FORM_DIALOG_WIDGET, source: 'widget' },
  ];
}
...
const LIST_WIDGET = `<script setup>
...
const DETAIL_WIDGET = `<script setup>
import { computed } from 'vue';
...
const TEXT_WIDGET = `<script setup>
import { computed } from 'vue';
...
const LIST_PAGED_WIDGET = `<script setup>
/**
...
const QUERY_FORM_WIDGET = `<script setup>
/**
...
const FORM_DIALOG_WIDGET = `<script setup>
/**
