...
export const WIDGET_KINDS = [
  ...
  {
    id: 'listPaged',
    labelKey: 'sch_listPaged',
    descKey: 'sch_listPaged_d',
    category: 'data',
    icon: 'list-paged',
  ...
  {
    id: 'markdown',
    labelKey: 'sch_markdown',
    descKey: 'sch_markdown_d',
    category: 'data',
    icon: 'markdown',
    allowedSources: [],
    defaultConfig: { body: '' },
  ...
  {
    id: 'progress',
    labelKey: 'sch_progress',
    descKey: 'sch_progress_d',
    category: 'viz',
    icon: 'progress',
    allowedSources: ['storeState', 'storeCompute', 'customVar'],
  ...
  {
    id: 'timeline',
    labelKey: 'sch_timeline',
    descKey: 'sch_timeline_d',
    category: 'viz',
    icon: 'timeline',
    allowedSources: ['endpoint', 'storeState', 'customVar'],
    rowClickable: true,   // ★ v1.9.0 — 행이 있어 클릭 대상이 된다
  ...
  {
    id: 'queryForm',
    labelKey: 'sch_queryForm',
    descKey: 'sch_queryForm_d',
    category: 'action',
    icon: 'form-query',
    allowedSources: ['endpoint'],
    defaultConfig: {
  ...
  {
    id: 'formDialog',
    labelKey: 'sch_formDialog',
    descKey: 'sch_formDialog_d',
    category: 'action',
    icon: 'form-dialog',
    allowedSources: ['endpoint'],
    defaultConfig: {
...
export const COMPUTE_OPS = [
  { id: 'count',       labelKey: 'sch_count',        input: 'array',  output: 'number',  needsField: false, needsValue: false },
  { id: 'sum',         labelKey: 'sch_sum',          input: 'array',  output: 'number',  needsField: true,  needsValue: false },
  { id: 'avg',         labelKey: 'sch_avg',          input: 'array',  output: 'number',  needsField: true,  needsValue: false },
  { id: 'min',         labelKey: 'sch_min',        input: 'array',  output: 'number',  needsField: true,  needsValue: false },
  { id: 'max',         labelKey: 'sch_max',        input: 'array',  output: 'number',  needsField: true,  needsValue: false },
  { id: 'filterCount', labelKey: 'sch_filterCount',           input: 'array',  output: 'number',  needsField: true,  needsValue: true },
  { id: 'pluck',       labelKey: 'sch_pluck',             input: 'object', output: 'any',     needsField: true,  needsValue: false },
  { id: 'custom',      labelKey: 'sch_custom',    input: 'any',    output: 'any',     needsField: false, needsValue: false, needsFn: true },
];
...
export const HEADER_KINDS = [
  { id: 'page-title', labelKey: 'sch_page_title',      descKey: 'sch_page_title_d' },
  { id: 'crumbs',     labelKey: 'sch_crumbs',    descKey: 'sch_crumbs_d' },
  { id: 'stat-hero',  labelKey: 'sch_stat_hero',    descKey: 'sch_stat_hero_d' },
  { id: 'tabs',       labelKey: 'sch_tabs',            descKey: 'sch_tabs_d' },
  { id: 'none',       labelKey: 'sch_none',        descKey: 'sch_none_d' },
];
...
export const ROW_CLICK_ACTIONS = [
  { id: 'none', labelKey: 'sch_none', descKey: 'sch_none_d' },
  { id: 'navigate', labelKey: 'sch_navigate', descKey: 'sch_navigate_d' },
];
...
export const ROW_PRESETS = [
  { labelKey: 'rp_1',       widths: [12] },
  { labelKey: 'rp_2eq',  widths: [6, 6] },
  { labelKey: 'rp_3eq',  widths: [4, 4, 4] },
  { label: '2:1',         widths: [8, 4] },
  { label: '1:2',         widths: [4, 8] },
  { label: '1:2:1',       widths: [3, 6, 3] },
  { labelKey: 'rp_4eq',  widths: [3, 3, 3, 3] },
];
