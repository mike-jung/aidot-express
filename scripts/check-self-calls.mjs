...
if (uniq.length) {
  console.error('Calls an internal method the file does not define — it will throw TypeError at runtime:');
...
console.log(`self-calls: class files checked — no problems`);
