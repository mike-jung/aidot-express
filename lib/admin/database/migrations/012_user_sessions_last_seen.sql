...
ALTER TABLE user_sessions ADD COLUMN last_seen_at DATETIME NULL;
ALTER TABLE user_sessions ADD COLUMN leave_hint_at DATETIME NULL;
ALTER TABLE user_sessions ADD COLUMN end_reason VARCHAR(20) NULL;
CREATE INDEX idx_user_sessions_open ON user_sessions (ended_at, last_seen_at);
